...
public class BancoDados
{
    ...
    public BancoDados()
    {
        ...
        this.questoes[0][3] = new ModeloQuestao("Fácil: Os métodos de uma classe abstrata sempre precisam ter " +
                "qual(is) modificador(es) de acesso?",
                new String[] {
        ...
        this.questoes[0][4] = new ModeloQuestao("Fácil: Qual dos seguintes valores entrariam no seguinte laço if?" +
        ...
        this.questoes[0][5] = new ModeloQuestao("Fácil: Qual das seguintes declarações de classe main está errada?",
                new String[] {
                        "Public class main",
                        "public class main",
        ...
        this.questoes[0][7] = new ModeloQuestao("Fácil: Sobre a palavra static, assinale a alternativa incorreta.",
                new String[] {
